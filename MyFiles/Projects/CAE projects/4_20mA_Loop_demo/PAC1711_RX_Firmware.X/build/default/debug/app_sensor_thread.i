...
# 2 "<built-in>" 2
# 1 "app_sensor_thread.c" 2
# 53 "app_sensor_thread.c"
...
# 54 "app_sensor_thread.c" 2
# 1 "./app_sensor_thread.h" 1
# 53 "./app_sensor_thread.h"
...
# 61 "./app_sensor_thread.h" 2
# 164 "./app_sensor_thread.h"
void APP_SENSOR_THREAD_Initialize ( void );
# 197 "./app_sensor_thread.h"
void APP_SENSOR_THREAD_Tasks( void );
# 55 "app_sensor_thread.c" 2
# 78 "app_sensor_thread.c"
PAC1711_DEVICE_CONTEXT deviceContext;
PAC1711_DEVICE_INIT deviceInit;
uint32_t rsense = 2430000;
# 115 "app_sensor_thread.c"
...
void APP_SENSOR_THREAD_Initialize(void)
{
    ...
    deviceInit.i2c_init.i2cAddress = 0x45;
    ...
    deviceInit.i2c_init.i2cTransferCallbackSet = ((void*)0);


    deviceInit.syncMode = 1;
...
# 177 "app_sensor_thread.c"
void APP_SENSOR_THREAD_Tasks(void)
{

    if (PAC1711_Device_IsInitialized(&deviceContext) == 0){
